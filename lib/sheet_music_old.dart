...
class SheetMusicOld extends StatelessWidget {
      ...
      return Container(
        child: InkWell(
          ...
          child: SizedBox(
            ...
            width: _width,
            child: Image.asset(
              getPitchAsset(pitch, trebleClef),
              fit: BoxFit.fitWidth,
              colorBlendMode: BlendMode.srcATop,
              color: Colors.white,
            ),
      ...
      child: SizedBox(
        ...
        child: Container(
          ...
          child: Row(
              ...
              children: <Widget>[
                _buildClef(_width, _height, dark: dark),
                _buildScale(_width, _height, dark: dark),
                _buildPitch(_width, _height, dark: dark),
              ]),
        ),
      ),
    );
